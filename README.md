...
| layout @mixin                                           |                                                                                                                                                                      |
| `make-container();`                                     | Creates and specify a complete declaration for container element or section.                                                                                         |
| `make-container-fluid();`                               | Creates and specify a complete declaration for an auto-width container element or section.                                                                           |
